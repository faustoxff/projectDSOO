...
public class addEditClient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dniInput = new javax.swing.JTextPane();
        ...
        jScrollPane6.setViewportView(lastNameInput);

        jScrollPane7.setViewportView(dniInput);

        jScrollPane8.setViewportView(emailInput);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addEditClient().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextPane dniInput;
